...
MEM_TOTAL = 70_000_000
available_space = MEM_TOTAL - top_level_dir.size
space_required = 30_000_000 - available_space
total = min(directory.size for directory in all_dirs if directory.size >= space_required)

print(total)
submit(total, part="b", day=7, year=2022)